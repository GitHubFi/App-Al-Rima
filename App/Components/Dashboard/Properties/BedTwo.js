...
class BedTwo extends Component {
    constructor(props) {
        super(props)
        this.state = {
            valueSelect: 'newest',
    ...
    render() {
        ...
        return (
            <View style={{ flex: 1, backgroundColor: '#eee' }}>
                ...
                <View style={{ flex: 1 }}>
                    <FlatList
                        data={this.props.GET_TWO_BED_PROPERTY}
                        ...
                        renderItem={({ item, id }) => (
                            <View>
                                ...
                                <TouchableOpacity style={{
                                    ...
                                    onPress={() => this.props.navigation.navigate('TowBedRoom', { propertyItem: item })}>
...
function mapStateToProps(state) {
    ...
    return {
        ...
        GET_TWO_BED_PROPERTY: state.appReducer.GET_TWO_BED_PROPERTY
    }
}
...
export default connect(mapStateToProps, mapDispatchToProps)(BedTwo)
