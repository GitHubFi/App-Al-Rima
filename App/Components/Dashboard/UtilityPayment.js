...
import { utilitytAction, } from '../../Store/Actions/AppAction'




class UtilityPayment extends Component {
    constructor(props) {
        super(props);
        this.state = {
            selected2: undefined,
    ...
    submit = async () => {
        ...
        const { cardNumber, date, cvc, RentforoneBed, payment, paid, name, BillId,id } = this.state
        ...
        let serviceDetail = { cardNumber, date, cvc, user, RentforoneBed, paid, name, payment, BillId ,id}
...
function mapDispatchToProps(dispatch) {
    return {
        paymentComponent: data => {
            dispatch(utilitytAction(data))
        }
    }
}
export default connect(mapStateToProps, mapDispatchToProps)(UtilityPayment)